...
<a href="IEmployee.php" class="q-btn">Add Employee </a>   
<a href="DEmployee.php" class="q-btn">Remove Employee</a> 
<button type="submit" class="q-btn" name="Submit" id="Submit">View All Employee</button> 
</form>
</div>  
<!---------php------>
<?php
...
?>
  <tr>
    ...
    <td><?php echo $data['Adresss']; ?></td>
    <td><?php echo $data['Sex']; ?></td>
    <td><?php echo $data['Salary']; ?></td>
    <td><?php echo $data['Super_SSN']; ?></td>
