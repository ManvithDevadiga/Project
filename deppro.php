...
<a href="IProject.php" class="q-btn">Add Project Details</a>   
<a href="DProject.php" class="q-btn">Remove Project Details</a> 
    <button type="submit" class="q-btn" name="Submit" id="Submit">View All Project Details</button>
</form>
</div>  
<!---------php-------->
...
$records = mysqli_query($conn,"select * from Project"); // fetch data from database
