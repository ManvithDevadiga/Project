 ...
 <section class="misc1">
  ...
  <h1 align="center">Enter Values </h1>
    ...
    <form class="comment-form" action="" method="post" align="center">
        ...
        <p1><label for="SSN">SSN</label></p1>
        <input type="text" name="SSN" class="form-control" id="SSN" placeholder="Enter SSN"><br><br><br>
...
<?php
  // Die if connection was not successful
    ...
    {                         
        ...
        $del = "DELETE FROM `Works_on` WHERE ('$SSN')";
