...
<h1>Check Out The Company and Project Details</h1>        

        
<!--------------Info-------------->
<div class="btn">
<form class="q">
<a href="deptd.php" class="q-btn">Department Details </a>   
<a href="deppro.php" class="q-btn">Project Details </a>   
<a href="deptloc.php" class="q-btn">Department Locations </a>   
<a href="deptworks.php" class="q-btn">Work Details </a>   
