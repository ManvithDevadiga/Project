...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
 ...
 <section class="misc1">
  ...
  <h1 align="center">Enter Values </h1>
    ...
    <form action="" class="comment-form" method="post" align="center">
    
        <p1><label for="Dno">Dloc</label></p1>
        <input type="text" name="Dloc" class="form-control" id="Dloc" placeholder="Enter Dloc"><br><br><br>
...
<?php
    ...
    {                         
        ...
        $del = "DELETE FROM `DLocation` WHERE ('$Dloc')";
