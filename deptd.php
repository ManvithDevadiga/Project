...
<a href="IDepartment.php" class="q-btn">Add Department Information </a>   
<a href="DDepartment.php" class="q-btn">Remove Department Information</a> 
    <button type="submit" class="q-btn" name="Submit" id="Submit">View All Department information</button> 
</form>
</div>
...
$records = mysqli_query($conn,"select * from department"); // fetch data from database
...
?>
  <tr>
    ...
    <td><?php echo $data['MgrSSN']; ?></td>
    <td><?php echo $data['MgrStartDate']; ?></td>
  </tr> 
<?php
}
}
