...
<a href="IWorks%20on.php" class="q-btn">Add Work Details </a>   
<a href="DWorks%20on.php" class="q-btn">Remove Work Details</a> 
    <button type="submit" class="q-btn" name="Submit" id="Submit">View All Work Details</button> 
</form>
</div>
<!---------php-------->
 <?php

$records = mysqli_query($conn,"select * from Works_on"); // fetch data from database
