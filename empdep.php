...
<h1>Employee Dependent Section</h1>        
        
<!--------------Info-------------->
<div class="btn">
<form class="q">
<a href="IDependent.php" class="q-btn">Add Employee Dependent </a>   
<a href="DDependent.php" class="q-btn">Remove Dependent</a> 
    <button type="submit" class="q-btn" name="Submit" id="Submit">View All Employee Dependent</button>
</form>
</div>
...
$records = mysqli_query($conn,"select * from Dependent"); // fetch data from database
