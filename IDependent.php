...
<section class="misc1">
  ...
  <h1 align="center">Enter Values </h1>
    ...
    <form action="" method="post" align="center" class="comment-form">
        ...
        <p1><label for="ESSN">ESSN</label></p1>
        <input type="text" name="ESSN" class="form-control" id="ESSN"><br><br><br>
...
<br><br><br>
        <p1><label for="desc">Bdate</label></p1>
        <input type="Bdate"  name="Bdate" id="Bdate">
<br><br><br>
        <p1><label for="desc">Relationship</label></p1>
        <input type="Relationship"  name="Relationship" id="Relationship">
<br><br><br>
...
<?php
    ...
    {                         
        ...
        $sql = "INSERT INTO `Works_on`(`ESSN`, `Name`, `Sex`,`Bdate`,`Relationship`) VALUES ('$ESSN', '$Name', '$Sex','$Bdate','$Relationship')";
